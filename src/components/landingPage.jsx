            ...
            >
              <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-blue-600 hover:text-blue-700 transition-colors cursor-pointer
                  ...
                  Kristine
                  <span className="absolute bottom-0 left-0 w-full h-1 bg-blue-600 transform scale-x-0 
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <a 
                  href="/projects" 
                  className="group inline-flex items-center px-6 py-3 text-lg font-medium text-white bg-blue-600 
                             rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-1"
                ...
                <a 
                  href="/contact" 
                  className="inline-flex items-center px-6 py-3 text-lg font-medium text-blue-600 border-2 
                             border-blue-600 rounded-lg hover:bg-blue-50 transition-all duration-300 
